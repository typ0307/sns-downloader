...
MESSAGES = {
    "ko": {
        ...
        "errors": {
            "UNSUPPORTED_URL": "지원하지 않는 URL입니다. Instagram, X(Twitter), Pinterest 핀 링크만 지원합니다.",
    ...
    "en": {
        ...
        "errors": {
            "UNSUPPORTED_URL": "Unsupported URL. Only Instagram, X (Twitter), and Pinterest pin links are supported.",
    ...
    "ja": {
        ...
        "errors": {
            "UNSUPPORTED_URL": "対応していないURLです。Instagram、X(Twitter)、Pinterest のピンのリンクのみ対応しています。",
    ...
    "zh": {
        ...
        "errors": {
            "UNSUPPORTED_URL": "不支持的链接。仅支持 Instagram、X(Twitter) 和 Pinterest 图钉链接。",
